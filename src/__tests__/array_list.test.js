...
describe('ArrayList', () => {
  describe('ArrayList basic functions', () => {
    let list = null
    beforeAll(() => {
      list = new ArrayList()
    })
  ...
  describe('ArrayList run with 100 items', () => {
    test('list.size === 100', () => {
  ...
  describe('ArrayList run with 1000 items', () => {
    test('list.size === 1000', () => {
      const list = new ArrayList()
      const timer = new Timer()
      fillList(list, 1000)
  ...
  describe('ArrayList run with 10000 items', () => {
  ...
  describe('ArrayList run with 100000 items', () => {
  ...
  describe('ArrayList run with 1000000 items', () => {
  ...
  describe('ArrayList run with 10000000 items', () => {
